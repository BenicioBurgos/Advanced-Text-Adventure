...
namespace Advanced_Text_Adventure
{
    internal class Program
    {
        ...
        static readonly int[][] inputIds = [[], [32], [70, 74], [70, 74, 75], [68, 70, 74, 75], [68, 70, 32, 74, 75], [83, 68, 70, 74, 75, 76], [83, 68, 70, 32, 74, 75, 76], [65, 83, 68, 70, 74, 75, 76, 58], [65, 83, 68, 70, 32, 74, 75, 76, 58], [65, 83, 68, 70, 86, 80, 74, 75, 76, 58]];
        static readonly int[] menuInputIds = [38, 40, 13, 27];
        static readonly string[] menuOptions = ["Play", "Import", "Settings", "Quit"];

        public static int offset = 620;
        public static float scrollSpeed = 1.8f;
        public static int laneHeight = 20;
        public static int songSelectSize = 19;
                        ...
                        while (true)
                        {
                            ...
                            if (play)
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    for (int i = 0; i < inputIds[currentKeys].Length; i++)
                                    {
                                        if (GetAsyncKeyState(inputIds[currentKeys][i]) != 0)
                                        {
        ...
        public static void DrawStats()
        {
            ...
            Console.SetCursorPosition(x, laneHeight);
            if (hitDelta == 0)
                Console.Write("     ");
            else if (hitDelta < 0)
        ...
        public static void LoadSongs()
        {
            ...
            for (int i = 0; i < songPaths.Length; i++)
            {
                ...
                songs.Add(new(songName, artistName, songPaths[i], audioFiles, difficultyPaths, difficultyNames, keyCounts, imagePath));
            }
        }
    ...
    class Song(string name, string artist, string path, string[] audioFiles, string[] chartPaths, string[] chartNames, int[] keyCounts, string? imagePath)
    {
